...
## Project Structure
    ...
    ├── ideaprocs_protege_s_36363  # Django project configurations
...
1. Clone this repo and `cd ideaprocs_protege_s_36363`
...
2. Clone this repo and `cd ideaprocs_protege_s_36363`
